...
router.get('/v6/pre-one-login/sign-in-email', function (req, res) {
  // Set URl
  res.render('v6/pre-one-login/sign-in-email', {
    currentUrl: req.originalUrl
  })
})

router.post('/v6/pre-one-login/sign-in-email', function (req, res) {
  ...
  if (req.session.data['signin-email'] === '') {
    ...
    res.redirect('/v6/pre-one-login/sign-in-password')
  }
})


// ******* Sign in password validation ********************************
router.get('/v6/pre-one-login/sign-in-password', function (req, res) {
  // Set URl
  res.render('v6/pre-one-login/sign-in-password', {
    currentUrl: req.originalUrl
  })
})

router.post('/v6/pre-one-login/sign-in-password', function (req, res) {
  // Create empty array and set error variables to false
  var errors = []
