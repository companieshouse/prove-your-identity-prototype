...
router.post('/release1-v1/pre-one-login/id-check', function (req, res) {
  // Create empty array
  var errors = []
  ...
  if (typeof req.session.data['has-ID'] === 'undefined') {
    ...
    if (req.session.data['has-ID'] == 'no-id' ) {
      res.redirect('/release1-v1/pre-one-login/acsp-alternate')
    } else {
      // User inputted value so move to next page
      res.redirect('/release1-v1/pre-one-login/one-login-intro')
    }
...
// ******* resident javascript ********************************
router.get('/release1-v1/pre-one-login/resident', function (req, res) {
  // Set URl
...
router.post('/release1-v1/pre-one-login/resident', function (req, res) {
  // Create empty array
  var errors = []
  ...
  if (typeof req.session.data['is-resident'] === 'undefined') {
    ...
    if (req.session.data['is-resident'] === 'yes') {
      ...
      // User inputted value so move to next page
      res.redirect('/release1-v1/pre-one-login/id-check')
    }
  }
})
...
router.get('/release1-v1/post-one-login/psc-existing-company', function (req, res) {
  // Set URl
...
router.post('/release1-v1/post-one-login/psc-existing-company', function (req, res) {
  // Create empty array
  var errors = []
  ...
  if (typeof req.session.data['psc-existing'] === 'undefined') {
    ...
    if (req.session.data['psc-existing'] === 'yes') {
      res.redirect('/release1-v1/post-one-login/company-number')
    } else {
      // User inputted value so move to next page
      res.redirect('/release1-v1/post-one-login/verified-success-psc')
    }
  }
})
...
router.get('/release1-v1/post-one-login/psc-statement-one', function (req, res) {
  // Set URl
...
router.post('/release1-v1/post-one-login/psc-statement-one', function (req, res) {
  // Create empty array
  var errors = []
  ...
  if (typeof req.session.data['verification-Statement-one'] === 'undefined') {
    ...
    res.redirect('/release1-v1/post-one-login/check-your-answers')
  }
})


// ******* psc-statement javascript ********************************
router.get('/release1-v1/post-one-login/psc-statement-two', function (req, res) {
  // Set URl
...
router.post('/release1-v1/post-one-login/psc-statement-two', function (req, res) {
  // Create empty array
  var errors = []
...
router.get('/release1-v1/post-one-login/check-your-answers', function (req, res) {
  // Set URl
...
router.post('/release1-v1/post-one-login/check-your-answers', function (req, res) {
  // Create empty array
  var errors = []
...
// ******* other-appointments javascript ********************************
router.get('/release1-v1/post-one-login/unlinked-identity', function (req, res) {
  // Set URl
...
router.post('/release1-v1/post-one-login/unlinked-identity', function (req, res) {
  // Create empty array
  var errors = []
...
router.get('/release1-v1/post-one-login/company-number', function (req, res) {
  // Set URl
...
router.post('/release1-v1/post-one-login/company-number', function (req, res) {
  // Create empty array and set error variables to false
  var errors = [];
  ...
  if (req.session.data['company-number'] === '') {
    ...
    res.render('release1-v1/post-one-login/company-number', {
      ...
      res.redirect('/release1-v1/post-one-login/correct-company')
  }
})
...
router.get('/release1-v1/post-one-login/linked-identity', function (req, res) {
  // Set URl
...
router.post('/release1-v1/post-one-login/linked-identity', function (req, res) {
  if (req.session.data['company-number'] === '02050399') {
    res.redirect('/release1-v1/post-one-login/psc-statement-one')
  } else {
    // User inputted value so move to next page
    res.redirect('/release1-v1/post-one-login/psc-statement-two')
  }
})
