...
router.post('/v8/pre-one-login/id-check', function (req, res) {
  // Create empty array
  var errors = []
  ...
  if (typeof req.session.data['has-ID'] === 'undefined') {
    ...
    if (req.session.data['has-ID'] == 'no-id' ) {
      res.redirect('/v8/pre-one-login/acsp-alternate')
    } else {
      // User inputted value so move to next page
      res.redirect('/v8/pre-one-login/one-login-intro')
    }
...
// ******* resident javascript ********************************
router.get('/v8/pre-one-login/resident', function (req, res) {
  // Set URl
  res.render('v8/pre-one-login/resident', {
    currentUrl: req.originalUrl
  })
})

router.post('/v8/pre-one-login/resident', function (req, res) {
  // Create empty array
  var errors = []
  ...
  if (typeof req.session.data['is-resident'] === 'undefined') {
    ...
    if (req.session.data['is-resident'] === 'yes') {
      ...
      // User inputted value so move to next page
      res.redirect('/v8/pre-one-login/id-check')
    }
  }
})
...
router.get('/v8/post-one-login/psc-existing-company', function (req, res) {
  // Set URl
  res.render('v8/post-one-login/psc-existing-company', {
    currentUrl: req.originalUrl
  })
})

router.post('/v8/post-one-login/psc-existing-company', function (req, res) {
  // Create empty array
  var errors = []
  ...
  if (typeof req.session.data['psc-existing'] === 'undefined') {
    ...
    if (req.session.data['psc-existing'] === 'yes') {
      res.redirect('/v8/post-one-login/company-number')
    } else {
      // User inputted value so move to next page
      res.redirect('/v8/post-one-login/verified-success-psc')
    }
  }
})
...
router.get('/v8/post-one-login/psc-statement-one', function (req, res) {
  // Set URl
  res.render('v8/post-one-login/psc-statement-one', {
    currentUrl: req.originalUrl
  })
})

router.post('/v8/post-one-login/psc-statement-one', function (req, res) {
  // Create empty array
  var errors = []
  ...
  if (typeof req.session.data['verification-Statement-one'] === 'undefined') {
    ...
    res.redirect('/v8/post-one-login/check-your-answers')
  }
})


// ******* psc-statement javascript ********************************
router.get('/v8/post-one-login/psc-statement-two', function (req, res) {
  // Set URl
  res.render('v8/post-one-login/psc-statement-two', {
    currentUrl: req.originalUrl
  })
})

router.post('/v8/post-one-login/psc-statement-two', function (req, res) {
  // Create empty array
  var errors = []
...
router.get('/v8/post-one-login/check-your-answers', function (req, res) {
  // Set URl
  res.render('v8/post-one-login/check-your-answers', {
    currentUrl: req.originalUrl
  })
})

router.post('/v8/post-one-login/check-your-answers', function (req, res) {
  // Create empty array
  var errors = []
...
// ******* other-appointments javascript ********************************
router.get('/v8/post-one-login/unlinked-identity', function (req, res) {
  // Set URl
  res.render('v8/post-one-login/unlinked-identity', {
    currentUrl: req.originalUrl
  })
})

router.post('/v8/post-one-login/unlinked-identity', function (req, res) {
  // Create empty array
  var errors = []
...
router.get('/v8/post-one-login/company-number', function (req, res) {
  // Set URl
  res.render('v8/post-one-login/company-number', {
    currentUrl: req.originalUrl
  })
})

router.post('/v8/post-one-login/company-number', function (req, res) {
  // Create empty array and set error variables to false
  var errors = [];
  ...
  if (req.session.data['company-number'] === '') {
    ...
    res.render('v8/post-one-login/company-number', {
      ...
      res.redirect('/v8/post-one-login/correct-company')
  }
})


// ******* smartphone-type javascript ********************************
router.get('/v8/one-login/computer', function (req, res) {
  // Set URl
  res.render('v8/one-login/computer', {
    currentUrl: req.originalUrl
  })
})

router.post('/v8/one-login/computer', function (req, res) {
  // Create empty array
  var errors = []
  ...
  if (typeof req.session.data['laptop'] === 'undefined') {
    ...
    if (req.session.data['laptop'] === 'no') {
      res.redirect('/v8/one-login/computer')
    } else {
      // User inputted value so move to next page
      res.redirect('/v8/one-login/smartphone-type')
    }
  }
})
...
// ******* smartphone-type javascript ********************************
router.get('/v8/one-login/smartphone-type', function (req, res) {
  // Set URl
  res.render('v8/one-login/smartphone-type', {
    currentUrl: req.originalUrl
  })
})

router.post('/v8/one-login/smartphone-type', function (req, res) {
  // Create empty array
  var errors = []
  ...
  if (typeof req.session.data['smartphone'] === 'undefined') {
    ...
    if (req.session.data['smartphone'] === 'no') {
      ...
      // User inputted value so move to next page
      res.redirect('/v8/one-login/interruption-card')
    }
  }
})
...
// ******* passport javascript ********************************
router.get('/v8/one-login/passport', function (req, res) {
  // Set URl
  res.render('v8/one-login/passport', {
    currentUrl: req.originalUrl
  })
})

router.post('/v8/one-login/passport', function (req, res) {
  // Create empty array
  var errors = []
  ...
  if (typeof req.session.data['passport'] === 'undefined') {
    ...
    if (req.session.data['passport'] === 'yes') {
      ...
      // User inputted value so move to next page
      res.redirect('/v8/one-login/passport')
    }
  }
})
...
router.get('/v8/post-one-login/linked-identity', function (req, res) {
  // Set URl
  res.render('v8/post-one-login/linked-identity', {
    currentUrl: req.originalUrl
  })
})

router.post('/v8/post-one-login/linked-identity', function (req, res) {
  if (req.session.data['company-number'] === '02050399') {
    res.redirect('/v8/post-one-login/psc-statement-one')
  } else {
    // User inputted value so move to next page
    res.redirect('/v8/post-one-login/psc-statement-two')
  }
})
